...
// === Configuration Multer (en mémoire, pas de dossier uploads local) ===
...
// === Contrôleur principal : ajout d’un objet à vendre ===
exports.ajoutVente = (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      console.error('Erreur Cloudinary / ajoutVente :', error);
